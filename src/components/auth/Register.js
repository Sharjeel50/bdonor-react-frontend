...
import { AppProvider, Button, TextField, FormLayout, Form, Checkbox, Layout, Card } from '@shopify/polaris';
...
class Register extends Component {
  ...
  handleSubmit = (event) => {
      ...
      axios.post('http://localhost:8020/create/${User.bloodGroup}/${User.firstname}/${User.lastname}/${User.email}/${User.password}/${User.address}/${User.postcode}');
