...
import { Card, AppProvider, Button, TextField, FormLayout, Form, Checkbox, Layout } from '@shopify/polaris';
...
class Login extends Component {
  ...
  handleSubmit = (event) => {
    ...
    axios.get('http://localhost:8020/login/${UserLogin.firstname}/${UserLogin.email}/${UserLogin.password}')
    .then(res => {
      console.log(res);
    })
